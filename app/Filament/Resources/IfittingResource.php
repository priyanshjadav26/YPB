...
use App\Filament\Resources\IfittingResource\Pages;
use App\Filament\Resources\IfittingResource\RelationManagers;
...
class IfittingResource extends Resource
{
    protected static ?string $model = Ifitting::class;

    protected static ?string $navigationIcon = 'heroicon-s-chart-pie';
    protected static ?string $navigationGroup = "MANUFACTURING";
    protected static ?string $pluralModelLabel = 'Fitting';
    ...
    public static function form(Form $form): Form
    {
                ...
                ->schema([
                    ...
                    ->relationship('worker', 'name', function (Builder $query) {
                        $query->where('department', 'fitting');
                    })
                    ->required(),
    ...
    {
        return [
            'index' => Pages\ListIfittings::route('/'),
            'create' => Pages\CreateIfitting::route('/create'),
            'edit' => Pages\EditIfitting::route('/{record}/edit'),
        ];
    }
}
