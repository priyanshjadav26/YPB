...
use App\Filament\Resources\JaboraResource\Pages;
use App\Filament\Resources\JaboraResource\RelationManagers;
...
class JaboraResource extends Resource
{
    protected static ?string $model = Jabora::class;

    protected static ?string $navigationIcon = 'heroicon-s-chart-pie';
    protected static ?string $navigationGroup = "MANUFACTURING";
    protected static ?string $pluralModelLabel = 'Jabora';
    ...
    {
        return [
            'index' => Pages\ListJaboras::route('/'),
            'create' => Pages\CreateJabora::route('/create'),
            'edit' => Pages\EditJabora::route('/{record}/edit'),
        ];
    }
}
