...
use App\Filament\Resources\FdiamondMeenaResource\Pages;
use App\Filament\Resources\FdiamondMeenaResource\RelationManagers;
...
class FdiamondMeenaResource extends Resource
{
    protected static ?string $model = FdiamondMeena::class;

    protected static ?string $navigationIcon = 'heroicon-s-chart-pie';
    protected static ?string $navigationGroup = "MANUFACTURING";
    protected static ?string $pluralModelLabel = 'Dimond/Meena';
        ...
        return $form
            ->schema([
                ...
                ->relationship('worker', 'name', function (Builder $query) {
                    $query->where('department', 'Mina / Dimond');
                })
                ->required(),
                ...
                Forms\Components\TextInput::make('weight')
                    ...
                    Forms\Components\TextInput::make('dimond_weight')
                    ->required()
                    ->numeric(),
                ...
                Forms\Components\TextInput::make('no_of_dimond')
                ->nullable()
                ->numeric(),
        ...
        return $table
            ->columns([
                ...
                //  ->formatStateUsing(fn($state) => $state . ' kg'),
                 Tables\Columns\TextColumn::make('dimond_weight')
    ...
    {
        return [
            'index' => Pages\ListFdiamondMeenas::route('/'),
            'create' => Pages\CreateFdiamondMeena::route('/create'),
            'edit' => Pages\EditFdiamondMeena::route('/{record}/edit'),
        ];
    }
}
